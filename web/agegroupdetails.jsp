...
<body>
    ...
    <p>A table which shows the number of people affected by COVID-19 age wise.</p> 
    </div>
	<div class="limiter">
				...
				<div class="table100 ver2 m-b-110">
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column2">Age Group</th>
									<th class="cell100 column3">Total Cases</th>
									<th class="cell100 column4">Percentage</th>
								</tr>
							</thead>
						</table>
					</div>
                    <div class="table100-body js-pscroll">
                        <table>
                            <tbody>
                                <%
                                String fname = "https://raw.githubusercontent.com/coderrag/covid19/master/AgeGroupDetails.csv";
