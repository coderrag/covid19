...
<body>
    ...
    <h1>Testing Labs</h1>
    <p>The table showing testing labs availabe in India.</p> 
    </div>
	<div class="limiter">
				...
				<div class="table100 ver1 m-b-110">
						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">Lab</th>
									<th class="cell100 column2">Address</th>
									<th class="cell100 column3">Pincode</th>
                    ...
                    <div class="table100-body js-pscroll">
                        <table>
                            <tbody>
                                <%
                                String fname = "https://raw.githubusercontent.com/coderrag/covid19/master/testing_labs.csv";
                                int count = 0,i = 0;
                                ...
                                while((thisLine = input.readLine())!=null)
                                {
                                    ...
                                    if(i++!=0)
                                    {
                                        ...
                                        out.print("<td class=\" cell100 column6\">" + row[5] + "</td>");
                                    }
                                    %></tr><%
                                }
                                %>
